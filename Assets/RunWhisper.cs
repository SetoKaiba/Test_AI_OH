...
public class RunWhisper : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Model decoder = ModelLoader.Load(decoderAsset);
        ...
        Model encoder = ModelLoader.Load(encoderAsset);
        Model spectro = ModelLoader.Load(spectroAsset);
        ...
        outputTokens[1] = CHINESE;// ENGLISH;// GERMAN;//FRENCH;//
    ...
    void EncodeAudio()
    {
        ...
        spectroOutput.CompleteOperationsAndDownload();
